    ...
    constructor() {
        ...
        this.app.post(
            ...
            async (req: express.Request, res: express.Response) => {
                ...
                // const feasibilityContext = composeContext({
                //     state,
                //     template: messageHandlerTemplate + `\nCan you generate a perfect response based on this content? Reply with 'yes' or 'no'.`,
                // });

                // const feasibilityResponse = await generateMessageResponse({
                //     runtime: runtime,
                //     context: feasibilityContext,
                //     modelClass: ModelClass.SMALL,
                // });

                // console.log("Feasible: ",feasibilityResponse);
